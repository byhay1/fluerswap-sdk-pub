...
describe('Pair', () => {
  ...
  const OASISETH_MAINNET_WONE = new Token(
    ChainId.OASISETH_MAINNET,
    '0xcF664087a5bB0237a0BAd6742852ec6c8d69A27a',
    18,
    'WONE',
    'Wrapped ONE'
  )
  const OASISETH_MAINNET_BUSD = new Token(
    ChainId.OASISETH_MAINNET,
  ...
  describe('#getAddress', () => {
    ...
    it('returns the correct address for Harmony Mainnet', () => {
      expect(Pair.getAddress(OASISETH_MAINNET_WONE, OASISETH_MAINNET_BUSD)).toEqual(
        '0x4Af68AD33Eb03960CE146D4EcFBA8f583D4A7AD8'
      )
    })
  })
